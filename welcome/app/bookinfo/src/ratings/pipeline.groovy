pipeline {
    ...
    parameters {
       ...
       string( name: 'imageName' , defaultValue : "ratings")  // Replace with your Docker image name
        string (name : 'BUILD_NUMBER', defaultValue : "${env.BUILD_NUMBER}")
        string(name : 'branch', defaultValue : "jenkins-workshop")
        string(name : 'dockerfile', defaultValue : "devopshift-welcome/welcome/app/bookinfo/src/ratings" ) 
    }
